...
import { IntersectionObserverHookArgs, IntersectionObserverHookRootRefCallback, UseInfiniteScrollHookRefCallback } from 'models/InfiniteScrollHookModel';
...
export type UseInfiniteScrollHookArgs = Pick<IntersectionObserverHookArgs, 'rootMargin'> & {
