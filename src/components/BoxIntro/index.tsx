...
const BoxIntro: FC<BoxIntroProps> = ({
    ...
    return (
        <Flex onMouseEnter={hanleMouse1} onMouseLeave={hanleMouse2} className='absolute overflow-hidden top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center' >
            ...
            <Box border={`2px solid ${mainColor.white}`} p={10} bg='transparent' >
                ...
                <Text fontSize={'xl'} color={active ? mainColor.black : mainColor.white} transition='0.3s all'>
                    {content}
                </Text>
            </Box>
        </Flex>
