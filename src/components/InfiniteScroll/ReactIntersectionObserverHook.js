...
function useIntersectionObserver(args) {
    ...
    var entry = _useState[0]
    var setEntry = _useState[1]
    ...
    var initializeObserver = useCallback(
        function () {
            unobserve()
            observe()
        },
    ...
    var rootRefCallback = useCallback(
        function (rootNode) {
...
function useTrackVisibility(args) {
    ...
    var ref = _useIntersectionObser[0]
    var result = _useIntersectionObser[1]
    ...
    var wasEverVisible = _useState[0]
    var setWasEverVisible = _useState[1]
