...
export const fetchVoucher = createAsyncThunk('voucher/list', async () => {
...
export const voucherSlice = createSlice({
    ...
    reducers: {
        fetchVoucherListSearch: (
            state: VoucherInitState,
            action: PayloadAction<ListResponseModel<VoucherData>>,
        ) => {
...
export const { fetchVoucherListSearch } = voucherSlice.actions
